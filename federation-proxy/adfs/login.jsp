...
%><fmt:bundle basename="org.wso2.carbon.identity.application.authentication.endpoint.i18n.Resources">
    ...
    <header class="header header-default">
        ...
        <div class="container-fluid">
            <div class="pull-left brand float-remove-xs text-center-xs">
                <a href="#">
                    <img src="images/adfs.jpg" alt="wso2" title="wso2" class="logo">

                    <h1><em>Active Directory Federation Services</em></h1>
                </a>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-3 col-centered wr-content wr-login col-centered">
                    <div>
                        <h2 class="wr-title uppercase blue-bg padding-double white boarder-bottom-blue margin-none">Sign in with ADFS</h2>
                    </div>
    ...
    <footer class="footer">
        <div class="container-fluid">
            <p>Active Directory Federation Services | &copy;
