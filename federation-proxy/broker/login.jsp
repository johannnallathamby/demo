                            ...
                            <div class="form-group">
                                ...
                                <a href="#" data-toggle="popover" data-placement="bottom"
                                   title="Sign in with <%=Encode.forHtmlAttribute(idpName)%>" id="popover" id="icon-<%=iconId%>">
                                    <% if ("ADFS".equals(idpName)) { %>
                                    <img class="idp-image" src="images/adfs.jpg”
                                         title="Sign in with <%=Encode.forHtmlAttribute(idpName)%>"/>
                                    <% } else if ("RedHat".equals(idpName)) { %>
                                    <img class="idp-image" src="images/redhat.png"
                                         title="Sign in with <%=Encode.forHtmlAttribute(idpName)%>"/>
                                    <% } else {%>
                                ...
                                forUriComponent(idpName))%>',
                                   ...
                                   href="#" id="icon-<%=iconId%>">
				    <% if ("ADFS".equals(idpName)) { %>
                                    <img class="idp-image" src="images/adfs.jpg" data-toggle="tooltip" data-placement="top" title="Sign in with <%=Encode.forHtmlAttribute(idpName)%>"/>
                                    <% } else if ("RedHat".equals(idpName)) { %>
                                    <img class="idp-image" src="images/redhat.png" data-toggle="tooltip" data-placement="top" title="Sign in with <%=Encode.forHtmlAttribute(idpName)%>"/>
                                    <% } else {%>
                                    <img class="idp-image" src="images/login-icon.png" data-toggle="tooltip" data-placement="top" title="Sign in with <%=Encode.forHtmlAttribute(idpName)%>"/>
                                    <% } %>
                                </a>
                                <label for="icon-<%=iconId%>"><%=Encode.forHtmlContent(idpName)%></label>
                                    </div>
